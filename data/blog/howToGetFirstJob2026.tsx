...
export const howToGetFirstJob2026: BlogContent = {
    id: "first-it-job-freshers-2026",
    slug: "first-it-job-freshers-2026",
    title: "How to Get Your First IT Job as a Fresher in 2026 (Step‑by‑Step Guide)",
    excerpt:
        "Step‑by‑step guide for freshers on how to get their first IT job in 2026, including skills, projects, resume tips, and application strategy.",
    ...
    content: (
        <div className="prose prose-slate max-w-none prose-lg">
            ...
            <div className="my-10">
                <img
                    src="/images/it-job-roadmap-for-freshers.jpg"
                    alt="IT job roadmap for freshers in 2026"
                    className="rounded-3xl shadow-xl border border-slate-200"
                />
                <p className="text-center text-sm text-slate-500 mt-4 italic">
                    IT job roadmap for freshers
                </p>
            </div>
            ...
            <ul className="space-y-4 my-8">
                <li className="flex items-start gap-3">
                    ...
                    <span>Learn one programming language well, such as Python, JavaScript, or Java.</span>
                </li>
                <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1">✔</span>
                    <span>Understand basics like logic building, loops, arrays, and simple problem‑solving.</span>
                </li>
                <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1">✔</span>
                    <span>Get comfortable with Git and GitHub to show your work clearly.</span>
                </li>
                <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1">✔</span>
                    <span>Practice basic communication and simple interview questions.</span>
                </li>
                <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1">✔</span>
                    <span>For testing roles, add test case writing and bug reporting basics.</span>
                </li>
                <li className="flex items-start gap-3">
                    <span className="text-emerald-500 mt-1">✔</span>
                    <span>Build at least 2–3 small projects that solve real small problems.</span>
                </li>
            </ul>

            <div className="my-10">
                <img
                    src="/images/fresher-skill-checklist.jpg"
                    alt="Skills checklist for IT jobs for freshers"
                    className="rounded-3xl shadow-xl border border-slate-200"
                />
                <p className="text-center text-sm text-slate-500 mt-4 italic">
                    fresher skill checklist
                </p>
            </div>
